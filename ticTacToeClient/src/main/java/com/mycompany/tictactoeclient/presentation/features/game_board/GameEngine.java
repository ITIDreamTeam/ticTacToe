...
public class GameEngine {
    ...
    public static enum gameDifficulty { Easy, Medium, Hard };
...
//    }
    ...
    private class MinimaxAlgorithm {
        ...
        private int[] getGoodButNotPerfectMove(Player[][] board, Player currentPlayer) {
            ...
            if (board[0][0] == Player.NONE) corners.add(new int[]{0, 0});
            if (board[0][2] == Player.NONE) corners.add(new int[]{0, 2});
            if (board[2][0] == Player.NONE) corners.add(new int[]{2, 0});
            if (board[2][2] == Player.NONE) corners.add(new int[]{2, 2});
        ...
        private int evaluateBoard(Player[][] board, Player player, Player opponent) {
            ...
            else if (board[1][1] == opponent) score -= 3;
            
            int[][] corners = {{0,0}, {0,2}, {2,0}, {2,2}};
            for (int[] corner : corners) {
                if (board[corner[0]][corner[1]] == player) score += 2;
                else if (board[corner[0]][corner[1]] == opponent) score -= 2;
            }
