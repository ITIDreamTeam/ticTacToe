...
//    }
    ...
    public boolean addGame(String playerOneName, String playerTwoName, String winnerName) {
        ...
        try (Connection con = DBConnection.getConnection(); PreparedStatement getPlayerStmt1 = con.prepareStatement(getPlayerIdSql); PreparedStatement getPlayerStmt2 = con.prepareStatement(getPlayerIdSql); PreparedStatement getWinnerid = con.prepareStatement(getPlayerIdSql); PreparedStatement insertStmt = con.prepareStatement(sql)) {
...
//    }
    public List<PlayerStatsDto> getLeaderBoardPlayers(String playerName) {
        ...
        try (Connection con = DBConnection.getConnection(); PreparedStatement ps1 = con.prepareStatement(sqlGetPlayerId); PreparedStatement ps = con.prepareStatement(sql)) {
    ...
    public boolean updatePassword(String username, String newPassword) {
        String sql = "UPDATE PLAYER SET PASSWORD = ? WHERE NAME = ?";
